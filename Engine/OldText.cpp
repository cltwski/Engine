...
OldText::OldText(const OldText& other)
{}
...
bool OldText::InitSentence(Sentence** sentence, int maxLength, ID3D11Device* device)
{
...
bool OldText::UpdateSentence(char* text, ID3D11DeviceContext* deviceContext)
{
	int numLetters;
	VertexTextureType* vertices;
	HRESULT result;
...
bool OldText::UpdateSentence(char* text, float red, float green, float blue, ID3D11DeviceContext* deviceContext)
{
	int numLetters;
	VertexTextureType* vertices;
	HRESULT result;
...
bool OldText::UpdateSentence(char* text, int posX, int posY, float red, float green, float blue,
...
void OldText::ReleaseSentence(Sentence** sentence)
{
	if(*sentence)
	{
...
bool OldText::RenderSentence(ID3D11DeviceContext* deviceContext, Sentence* sentence, D3DXMATRIX worldMatrix, 
...
char* OldText::GetWords()
{
	return _words;
}

GUID OldText::GetGuid()
{
	return _guid;
}